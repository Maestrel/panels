local uber_warp = {
    ...
    },
    {
        name = "Bastok",
        buttons = {
            { label = "BastokMarkets - South Gustaberg exit", command = "/uw hp BastokMarkets" , description = "" },
            { label = "BastokMarkets 2", command = "/uw hp BastokMarkets 2" , description = "" },
            { label = "BastokMarkets 3", command = "/uw hp BastokMarkets 3" , description = "" },
            { label = "BastokMarkets 4 - Goldsmithing Guild", command = "/uw hp BastokMarkets 4" , description = "" },
            { label = "BastokMines - Auction House", command = "/uw hp BastokMines" , description = "" },
            { label = "BastokMines 2", command = "/uw hp BastokMines 2" , description = "" },
            { label = "BastokMines 3", command = "/uw hp BastokMines 3" , description = "" },
            { label = "Metalworks", command = "/uw hp Metalworks" , description = "" },
            { label = "Metalworks 2", command = "/uw hp Metalworks 2" , description = "" },
            { label = "PortBastok - North Gustaberg exit", command = "/uw hp PortBastok" , description = "" },
            { label = "PortBastok 2", command = "/uw hp PortBastok 2" , description = "" },
            { label = "PortBastok 3", command = "/uw hp PortBastok 3" , description = "" },
